...
class ResNet(nn.Module):
    def __init__(self,
        ...
        self.groups = groups
        self.conv1_s = layer.SeqToANNContainer(nn.Conv2d(1, channel, kernel_size=3, stride=2, padding=1, bias=False),
                                               nn.BatchNorm2d(channel))
        self.layer1 = self._make_layer(SNNBasicBlock, SNNConcatBlock, channel, layers[0], stride=2, name='layer1')
